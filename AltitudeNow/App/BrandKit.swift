...
// MARK: - Brand colors (AltitudeNow — altimeter)
// brandPrimary:   #33A673  emerald (matches accent color in Assets.xcassets)
// brandSecondary: #0E4A2C  deep forest
// brandTint:      #7DD3A1  sage highlight

extension Color {

    // Per-app brand
    static let brandPrimary   = Color(red: 0.20, green: 0.65, blue: 0.45)
    static let brandSecondary = Color(red: 0.05, green: 0.29, blue: 0.17)
    static let brandTint      = Color(red: 0.49, green: 0.83, blue: 0.63)
